...
bmob.new = function(self,id,key)
  self.id=id
  self.key=key
end

bmob.query = function(self,...)
  local arg={...}
  local c=arg[#arg]
  table.remove(arg)
  local fmt
...
bmob.insert = function(self,t,d,c)
...
bmob.update = function(self,t,i,d,c)
  if type(d)=="table" then
    d=cjson.encode(d)
  end
...
bmob.increment = function(self,t,i,k,v,c)
...
bmob.delete = function(self,t,i,c)
...
bmob.sign = function(self,u,p,e,c)
...
bmob.login = function(self,u,p,c)
